...
const BrowseRoom = () => {
  ...
  useEffect(() => {
    run(
      fetch(
        "https://dbc3f5cc-4082-423d-8fa2-be5305826d85.mock.pstmn.io/api/categories/?page=1&limit=4"
      ).then( async response => {
        const jssonResponse = await response.json()
        if(response.ok) return jssonResponse
