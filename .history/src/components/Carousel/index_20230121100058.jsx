...
const Carousel = ({ children, refContainer }) => {
  ...
  useLayoutEffect(() => {
    ...
    refFrowardDragHandler.addEventListener("touchend", onDragEnd);
    refFrowardDragHandler.addEventListener("touchmove", onDragMove);
    refFrowardDragHandler.addEventListener("click", onClick);
    refFrowardDragHandler.addEventListener("transitionend", fnCheckIndex);
    return () => {
      refFrowardDragHandler.removeEventListener("touchstart", onDragStart);
      refFrowardDragHandler.removeEventListener("touchend", onDragEnd);
      refFrowardDragHandler.removeEventListener("touchmove", onDragMove);
      refFrowardDragHandler.removeEventListener("click", onClick);
      refFrowardDragHandler.removeEventListener("transitionend", fnCheckIndex);
    };
